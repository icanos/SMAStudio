...
namespace Xceed.Wpf.AvalonDock.Controls
{
    public class LayoutAutoHideWindowControl : HwndHost, ILayoutControl
    {
        ...
        protected override IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            {
                // FIX 2016-03-11: Verify that _internalHwndSource.Handle is a valid window handle beofre trying to set position.
                //      This resolves an issue where the application crashes due to Invalid window handle being thrown.
                if (_internalHost_ContentRendered && Win32Helper.IsWindow(_internalHwndSource.Handle))
