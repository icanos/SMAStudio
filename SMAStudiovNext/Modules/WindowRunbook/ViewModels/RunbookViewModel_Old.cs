...
{
    public sealed class RunbookViewModelOld : Document, IViewModel, 
        ...
        ICommandHandler<EditPublishedCommandDefinition>
    {
        ...
        public RunbookViewModelOld(RunbookModelProxy runbook)
        {
        ...
        {
            var output = IoC.Get<IOutput>();
            var dialog = new PrepareRunWindow(null); //this);
            ...
            if ((bool)dialog.ShowDialog())
            {
                ...
                try
                {
                    ...
                    var executionViewModel = new ExecutionResultViewModel(null);// this);
                    var shell = IoC.Get<IShell>();
