...
{
    public class AzureRMService_old : IBackendService
    {
        ...
        public AzureRMService_old(IBackendContext context, BackendConnection connectionData)
        {
        ...
        public async Task<string> SendRequestAsync(string objectType, HttpMethod requestMethod, string requestBody = null, string contentType = null)
        {
            ...
            var url = AzureBaseUrl + string.Format(AzureResourceUrl, _connectionData.AzureSubscriptionId, _connectionData.AzureRMGroupName, _connectionData.AzureAutomationAccount, objectType);
        ...
        private async Task<string> SendRawRequestAsync(string url, HttpMethod requestMethod, string requestBody = null, string contentType = null, bool retryAutomatically = true)
        {
            ...
            try
            {
                ...
                request.Headers.Add("x-ms-principal-id", _connectionData.AzureRMServicePrincipalId);
                //request.Properties.Add("api-version", "2016-02-01");
                //request.Headers.Add("api-version", "2016-02-01");
        ...
        private async Task<AccessToken> GetTokenAsync(Guid tenantId)
        {
            ...
            if (token == null && refreshToken != null && refreshToken.refresh_token != null)
            {
                ...
                try
                {
                    ...
                    //request.Properties.Add("refresh_token", refreshToken.RefreshToken);
            ...
            if (token == null)
            {
                ...
                Console.WriteLine(restPacket.GetRestString());
