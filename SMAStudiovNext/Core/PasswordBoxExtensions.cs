...
namespace SMAStudiovNext.Core
{
    ...
    public static class PasswordBoxExtensions
    {
        public static readonly DependencyProperty BoundPassword =
            DependencyProperty.RegisterAttached("BoundPassword", typeof(string), typeof(PasswordBoxExtensions), new PropertyMetadata(string.Empty, OnBoundPasswordChanged));

        public static readonly DependencyProperty BindPassword = DependencyProperty.RegisterAttached(
            "BindPassword", typeof(bool), typeof(PasswordBoxExtensions), new PropertyMetadata(false, OnBindPasswordChanged));
